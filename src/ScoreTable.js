    ...
    return (
      <div className="ScoreTable">
        <section className="ScoreTable-section">
          ...
          <table cellSpacing="0">
            <tbody>
              <RuleRow name="Ones" score={scores.ones} doScore={evt => doScore("ones", ones.evalRoll)} description="1 point per 1"/>
        ...
        <section className="ScoreTable-section ScoreTable-section-lower">
          ...
          <table cellSpacing="0">
            <tbody>
              ...
              <RuleRow name="Full House" score={scores.fullHouse} doScore={evt => doScore("fullHouse", fullHouse.evalRoll)} description="25 points for a full house" />
        ...
        <section className="ScoreTable-section">
          ...
          <table cellSpacing="0">
            <tbody>
              <RuleRow name="Total Score" description={this.props.totalScore} />
            </tbody>
          </table>
        </section>
      </div>
